...
Для работы с репозиториями настроим SSH-доступ.
...
> Скрипт для клонирования репозиториев: [/src/scripts/clone_projects.sh](../../src/scripts/clone_projects.sh)
...
← [Part 1. Настройка GitLab Runner](Part1_ru.md)
